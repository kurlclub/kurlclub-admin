...
export const demoSubscriptions: DemoSubscription[] = [
  ...
  },
  {
    ...
    clientEmail: 'diya.patel@outlook.com',
    planName: 'Growth',
    status: 'Trial',
    amount: inr(2499),
    billingCycle: 'Monthly',
  ...
  },
  {
    ...
    clientEmail: 'ishaan.nair@gmail.com',
    planName: 'Pro',
    status: 'Active',
    amount: inr(4999),
    billingCycle: 'Yearly',
    renewsOn: daysFromNow(220),
  },
  {
    id: 4,
    clientName: 'Ananya Reddy',
    clientEmail: 'ananya.reddy@gmail.com',
    planName: 'Enterprise',
    status: 'Active',
    amount: inr(9999),
    billingCycle: 'Yearly',
    renewsOn: daysFromNow(140),
  },
  {
    id: 5,
    clientName: 'Kabir Mehta',
    clientEmail: 'kabir.mehta@gmail.com',
    planName: 'Starter',
    status: 'Past Due',
    amount: inr(999),
    billingCycle: 'Monthly',
  ...
  {
    id: 6,
    clientName: 'Saanvi Iyer',
    clientEmail: 'saanvi.iyer@gmail.com',
    planName: 'Growth',
    status: 'Cancelled',
    amount: inr(2499),
    billingCycle: 'Monthly',
  ...
  {
    id: 7,
    clientName: 'Vivaan Khan',
    clientEmail: 'vivaan.khan@outlook.com',
    planName: 'Pro',
    status: 'Active',
    amount: inr(4999),
    billingCycle: 'Six Months',
    renewsOn: daysFromNow(74),
  },
  {
    id: 8,
    clientName: 'Myra Bose',
    clientEmail: 'myra.bose@gmail.com',
    planName: 'Starter',
    status: 'Expired',
    amount: inr(999),
    billingCycle: 'Monthly',
...
export const demoUsers: DemoUser[] = [
  ...
  },
  {
    id: 2,
    name: 'Riya Kapoor',
    email: 'riya.kapoor@kurlclub.com',
    role: 'admin',
    status: 'active',
  ...
  },
  {
    id: 3,
    name: 'Arjun Menon',
    email: 'arjun.menon@kurlclub.com',
    role: 'admin',
    status: 'locked',
  ...
  },
  {
    id: 5,
    name: 'Reyansh Rao',
    email: 'reyansh.rao@kurlclub.com',
    role: 'admin',
    status: 'disabled',
...
export const demoAnnouncements = [
  ...
  {
    id: 2,
    title: 'New WhatsApp reminders are live',
    audience: 'Clients',
    status: 'Published',
  ...
  {
    id: 3,
    title: 'Festive offer — coming soon',
    audience: 'Gyms',
    status: 'Draft',
    publishedAt: null,
  },
...
export const demoHealthAlerts = [
  {
    ...
    service: 'WhatsApp',
    level: 'Critical',
    message: 'Delivery success rate dropped below 95%.',
    at: '4m ago',
  },
  {
    id: 2,
    service: 'WhatsApp',
    level: 'Warning',
    message: 'Average send latency above 400ms.',
    at: '22m ago',
  },
  {
    id: 3,
    service: 'Biometric',
    level: 'Warning',
    message: '3 devices missed their heartbeat window.',
    at: '1h ago',
  },
];

export const demoUptimeTrend = [
  99.9, 100, 99.8, 100, 99.6, 100, 99.9, 98.4, 99.9, 100, 99.95, 100,
];
...
export const demoLogs: Record<string, DemoLog[]> = {
  admin: [
    {
      ...
      time: daysAgo(0),
      actor: 'support@kurlclub.com',
      action: 'Suspended a gym',
      detail: 'Beast Mode Gym',
    },
    {
      id: 2,
      time: daysAgo(0),
  ...
  api: [
    {
      ...
      time: daysAgo(0),
      actor: 'system',
      action: 'POST /api/v1/payments/webhook',
      detail: '200 · 84ms',
    },
    {
      id: 2,
  ...
  usage: [
    ...
    },
    {
      ...
      time: daysAgo(0),
      actor: 'platform',
      action: 'API calls (24h)',
      detail: '482,910',
    },
  ],
};

export const demoPerfTrend = [
  120, 140, 110, 160, 130, 150, 125, 145, 135, 155, 128, 142,
];
