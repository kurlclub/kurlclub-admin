    ...
    <>
      ...
      <div className="ml-auto flex items-center gap-2">
        {canSwitchEnvironment ? (
          ...
          <div className="h-11 min-w-42.5 rounded-lg border border-primary-blue-300/40 bg-secondary-blue-600/40 px-4 text-sm font-semibold text-white flex items-center">
            {getApiEnvironmentLabel(environment)}
          </div>
        )}
      </div>
    </>
