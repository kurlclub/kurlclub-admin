  ...
  return (
    <OnboardingProvider>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
        <div className="bg-secondary-blue-500 rounded-2xl max-w-3xl w-full max-h-[90vh] overflow-hidden flex flex-col shadow-2xl border border-secondary-blue-400">
          {/* Header */}
          <div className="flex items-center justify-between p-8 border-b border-secondary-blue-400">
            <div>
            ...
            <button
              onClick={onClose}
              className="p-2 hover:bg-secondary-blue-600 rounded-lg transition-all hover:scale-110 duration-200"
            >
          ...
          <div className="flex items-center gap-2 px-8 pb-6 overflow-x-auto scrollbar-hide">
            {STEPS.map((step, idx) => {
          ...
          <div className="flex items-center justify-between p-8 border-t border-secondary-blue-400 bg-secondary-blue-600/50 backdrop-blur-sm">
            <button
